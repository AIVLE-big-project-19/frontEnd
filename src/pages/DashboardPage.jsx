...
const DashboardPage = () => {
  ...
  const sortedDemoSites = useMemo(
    () => sortSiteAnalyses(demoSites, candidateSort, candidateSortDirection),
    [demoSites, candidateSort, candidateSortDirection],
  );
